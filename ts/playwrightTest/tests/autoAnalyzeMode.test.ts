...
test.describe('PlaywrightTest: AutoAnalyze Mode Tests Validation', () => {
  test.beforeAll(() => {
    ...
    createAndSwitchToBranch('playwrighttest_autoanalyzemode')
    process.env.GIT_BRANCH = 'playwrighttest_autoanalyzemode'
  })
  ...
  test.afterAll(async () => {
    ...
    await verifyPagestateIssuesCount('autoAnalyzeMode', 'automation_Playwright Test', currentBranch || undefined)
